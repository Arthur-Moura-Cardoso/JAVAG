...
public class Tela_Cliente extends javax.swing.JFrame {
    ...
    public Tela_Cliente() {
        ...
        deletar_cliente.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        deletar_cliente = new javax.swing.JButton();
        ...
        getContentPane().add(remake_pesquisa, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 200, -1, 30));
        ...
        deletar_cliente.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        deletar_cliente.setText("Deletar ");
        deletar_cliente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                deletar_clienteActionPerformed(evt);
            }
        });
        getContentPane().add(deletar_cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 200, 130, 30));
    ...
    private void botao_pesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_pesquisarActionPerformed
        ...
        if(pergunta_field.getText().equals("")) {
            ...
            valores.cliente = resultado_pesquisa;
                ...
                if(Arrays.toString(resultado_pesquisa).equals("[notFound]")){
                    ...
                    deletar_cliente.setVisible(true);
    ...
    private void deletar_clienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletar_clienteActionPerformed
        String deletar =  Arrays.toString(valores.cliente);
        char[] valor = deletar.toCharArray();

        deletar_usuario.deletar_usuario(valor, "Clientes" , "ID_cliente");
        alerta.setVisible(true);
        alerta.setText("Usuário deletado com sucesso");
    ...
    private javax.swing.JButton deletar_cliente;
